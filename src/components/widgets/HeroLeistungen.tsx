        ...
        <section class="bg-fourth">
            <div class="pt-24 grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:pt-32 lg:grid-cols-12">
                <div class="mr-auto place-self-center lg:col-span-7">
                    ...
                    <a href="#" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-third hover:bg-third-700 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                        Zu den Preisen
